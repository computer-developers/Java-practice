...
public class GuiControl2 extends javax.swing.JPanel {
     int iwx=0,iwo=0;
     Consumer<?super String>cnewgame;
     GuiControl2(String px,String po){
          initComponents();
          nx.setText(px);
          no.setText(po);
     }
     
     public void setConsumer(Consumer<? super String>cs){
          cnewgame=cs;
     }
     
     public int getWin(eboard e){
          switch(e){
               case _O:return iwo;
               case _X:return iwx;
          }
     ...
     public void updateWin(eboard e,int i){
          if(e.c=='X')
               wx.setText(getw(i));
          else if(e.c=='O')
               wo.setText(getw(i));
     ...
     private String getw(int i){
          String s=new String("Match Won : "+i);
          return s;
     }
